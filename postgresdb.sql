...
ALTER TABLE BATCH_JOB_EXECUTION_SEQ ADD CONSTRAINT UNIQUE_KEY_UN UNIQUE (UNIQUE_KEY);
ALTER TABLE BATCH_JOB_SEQ ADD COLUMN UNIQUE_KEY char(1) NOT NULL;
ALTER TABLE BATCH_JOB_SEQ ADD CONSTRAINT UNIQUE_KEY_UN UNIQUE (UNIQUE_KEY);
...
ALTER TABLE BATCH_STEP_EXECUTION_SEQ ADD CONSTRAINT UNIQUE_KEY_UN UNIQUE (UNIQUE_KEY);